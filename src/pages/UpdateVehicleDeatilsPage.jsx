  ...
  useEffect(() => {
    ...
    const fetchVehicle = async () => {
      try {
        ...
        fetchedVehicle.yearOfManufacture =
          fetchedVehicle.yearOfManufacture !== undefined &&
          fetchedVehicle.yearOfManufacture !== null
            ? String(fetchedVehicle.yearOfManufacture)
            : "";

        console.log("Fetched vehicle (post-processing):", fetchedVehicle);
  ...
  return (
    <div className="w-11/12 mx-auto flex justify-center p-6">
      <form
        ...
        className="bg-white rounded-3xl p-8 shadow-2xl w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 gap-8"
      >
