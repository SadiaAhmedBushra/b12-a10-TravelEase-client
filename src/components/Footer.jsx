...
const Footer = () => {
  return (
    <footer className="relative w-11/12 mx-auto mt-60 bg-gradient text-white pt-40 pb-10">
      <div
        className="flex flex-col items-center gap-3 absolute -right-2/12 w-1/5 bg-opacity-10 rounded-full py-8 shadow-lg border-2 border-primary"
      ...
      <div className="w-11/12 mx-auto flex flex-col justify-between items-center gap-5">
        ...
        <div className="flex justify-between items-center gap-3 w-1/2 mx-auto text-sm">
