...
//   return (
//     <div className="bg-[#F0F8FF] dark:bg-gray-900  rounded-3xl shadow-md overflow-hidden transform hover:scale-105 hover:shadow-xl transition-transform duration-300 flex flex-col h-[480px]">
...
//               {vehicle.vehicleName}
//             </h2>
//             <div className="bg-gradient flex items-center gap-1 text-white">
